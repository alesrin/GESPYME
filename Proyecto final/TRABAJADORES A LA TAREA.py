...
#OJO OJO OJO MODIFICARLO PARA QUE SEA UNA SUBCLASE
#
#DEFINIR ESTO COMO UNA FUNCIÓN NO REPETIR EL CÓDIGO
...
#¿DEBERÍAMOS AÑADIR ESTA VARIABLE A LAS TABLAS DE NOTION?
    ...
    if entrada.lower() == "añadir": #FALTA TERMINAR EL CÓDIGO DE ESTE  if
        ...
        for trabajador in lista_trabajadores_eliminados:
            ...
            if len(lista_trabajadores)>1:#Para que no te pueda dejar con una lista de trabajores asignados a la tarea vacia. Es decir, que haya un trabajador mínimo asignado a la tarea.
               ...
               print(f"\nSe han eliminado todos los trabajadores que ha indicado excepto {lista_trabajadores}, ya que si no, habría ningún trabajador asignado a esta tarea")
